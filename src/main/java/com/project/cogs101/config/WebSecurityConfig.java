package com.project.cogs101.config;

import com.project.cogs101.repository.UserRepository;
import com.project.cogs101.service.impl.UserDetailsServiceImpl;
...
//    }
    ...
    public void configureGlobal(@Lazy AuthenticationManagerBuilder auth) throws Exception {
        auth.userDetailsService(new UserDetailsServiceImpl(userRepository)).passwordEncoder(webMvcConfig.passwordEncoder());
    }
